// Deprecated (merged with tiles to make tilemap)

// import {Direction, DirectionPriority, Spagbol, Vector2 } from "./spagbol";
// import { BooleanOperator, DataOperator } from "./expression";
...
//                             let expression: Spagbol.Expression = new Spagbol.Expression(lhs, null, null); // insert gathered values

//                             if(lhs instanceof ExpressionVariableTile) lhs.parentExpression = expression;
...
//                     let expression: Spagbol.Expression = new Spagbol.Expression(lhs, rhs, operator); // insert gathered values
...
//                     if(lhs instanceof ExpressionVariableTile) lhs.parentExpression = expression;
//                     if(rhs instanceof ExpressionVariableTile) rhs.parentExpression = expression;
...
//             let lhsVariableV = new ExpressionVariableTile(new Vector2(x,y), 
...
//             let lhsVariableH = new ExpressionVariableTile(new Vector2(x,y), 
//                 [DirectionPriority.CanNot,
//                 DirectionPriority.Can,
//                 DirectionPriority.CanNot,
//                 DirectionPriority.Can
...
//             break;
//         case "\"": // string literal
//             tileMap[y][x] = new HorizontalLineTile(new Vector2(x,y)); // opening quote
//             let lhsString: string = "";
//             x++;

//             while(lines[y][x] != "\"")
//             {   
//                 tileMap[y][x] = new HorizontalLineTile(new Vector2(x,y));
//                 lhsString += lines[y][x];
//                 x++
//             }

//             tileMap[y][x] = new HorizontalLineTile(new Vector2(x,y)); // closing quote
...
//             break;
//         default:
//             if( /[0-9]/.test(lines[x][y])) // number literal
//             {
//                 tileMap[y][x] = new HorizontalLineTile(new Vector2(x,y));
//                 let lhsNumberString: string = "";
//                 x++;
//                 let decimalPoint = false;
//                 while(/[0-9.]/.test(lines[x][y]))
//                 {
//                     if(decimalPoint && lines[x][y] == ".") // found a second one
//                     {
//                         break;
//                     }

//                     if(lines[x][y] == ".") decimalPoint = true;
//                     lhsNumberString += lines[x][y];
//                     tileMap[y][x] = new HorizontalLineTile(new Vector2(x,y));
//                     x++
//                 }
...
//         case "v": return new BranchTile(position, Direction.North);
//         case "^": return new BranchTile(position, Direction.South);
...
//         // case "{": return new OpeningCurlyBraceTile(position);
//         // case "(": return new OpeningParenthesisTile(position);
//         // case "[": return new OpeningSquareBracketTile(position);
     
//         case " ": return new EmptyTile(position);
//         default: 
//             console.log("Unrecognised character (throw error)");
...
// {
//     if(position.x >= tileMap[position.y].length || position.y >= tileMap.length)
//     {
//         console.log("attempting to fetch tile out of bounds (throw error)");
//         return new EmptyTile(position);
//     }
...
// {
//     expression: Spagbol.Expression; //

//     constructor(position: Vector2, expression: Spagbol.Expression)
//     {
//         super([DirectionPriority.CanNot,
//             DirectionPriority.Can,
//             DirectionPriority.CanNot,
